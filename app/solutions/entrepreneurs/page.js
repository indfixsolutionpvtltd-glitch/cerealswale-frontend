...
import { Briefcase, BarChart3, Tablet, Database, GraduationCap, Store, Users, CheckCircle } from "lucide-react";
...
const heroEntrepreneurStyle = { minHeight: "80vh", backgroundImage: "linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1590682680695-43b964a3ae17?w=1600')", backgroundSize: "cover", backgroundPosition: "center", display: "flex", alignItems: "center" };
