          ...
          <tbody>
            {orders.map((o) => (
              <tr key={o.id} style={{ borderBottom: "1px solid #eee" }}>
                ...
                <td style={tdStyle}>
                    <button onClick={() => rejectOrder(o.id)} style={rejectBtn} title="Reject Order"><Ban size={14}/></button>
                </td>
              </tr>
            ))}
          </tbody>
...
// Styles
const rejectBtn = { background: "#fee2e2", color: "#991b1b", border: "1px solid #991b1b", padding: "8px", borderRadius: "8px", cursor: "pointer" };
