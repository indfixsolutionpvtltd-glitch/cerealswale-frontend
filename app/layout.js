...
import { CartProvider } from "../context/CartContext"; // Naya Cart Context
  ...
  return (
    <html lang="en">
      <body style={{ margin: 0, fontFamily: 'Arial, sans-serif', background: "#fcfcfc" }}>
        {/* Poori App ko CartProvider mein wrap kiya taaki Cart fix ho jaye */}
        <CartProvider>
          <nav style={navStyle}>
...
// Styles
const navStyle = { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 5%", background: "#fff", boxShadow: "0 2px 10px rgba(0,0,0,0.05)", position: "sticky", top: 0, zIndex: 1000, flexWrap: "wrap" };
const navLinksStyle = { display: "flex", gap: "15px", fontSize: "12px", fontWeight: "600", alignItems: "center" };
...
const adminLinkStyle = { color: "#d32f2f", textDecoration: "none", border: "1px solid #d32f2f", padding: "4px 8px", borderRadius: "4px" };
const whatsappFloatBtn = { position: "fixed", bottom: "30px", right: "30px", backgroundColor: "#25d366", width: "60px", height: "60px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 15px rgba(0,0,0,0.2)", zIndex: 9999, cursor: "pointer", textDecoration: "none" };
